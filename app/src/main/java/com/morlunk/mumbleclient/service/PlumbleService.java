    ...
    private JumbleObserver mObserver = new JumbleObserver() {
        ...
        public void onConnected() {
            if (mNotification != null) {
                ...
                //1. 切换通道
                int channelBranch = Integer.parseInt(PlumbleActivity.branchcd);
                Log.getClassInfo("joinChannel123 branchcd："+channelBranch);
                joinChannel(channelBranch);
                PlumbleActivity.moveTaskToBack = "true";
//                moveTaskToBack(true);
            }
        }
